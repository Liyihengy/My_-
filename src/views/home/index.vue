...
<template>
  ...
  <div class="fottor pt-15 pb-5 text-xs lh-5 c-#62616F w-full max-w-242">
    <div class="copyright flex justify-center items-center gap-3">
  ...
  <div class="widget flex justify-center items-center w-full max-w-242">
